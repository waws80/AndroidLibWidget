package pw.androidthanatos.lib.widget.expandabletextview;
...
import pw.androidthanatos.lib.widget.expandabletextview.model.ExpandableStatusFix;
import pw.androidthanatos.lib.widget.expandabletextview.model.FormatData;
import pw.androidthanatos.lib.widget.expandabletextview.type.LinkType;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            mMentionTextColor = a.getColor(R.styleable.ExpandableTextView_ep_mention_color,
                    Color.parseColor("#FF6200"));
            int resId = a.getResourceId(R.styleable.ExpandableTextView_ep_link_res, R.drawable.icon_link);
            mLinkDrawable = getResources().getDrawable(resId);
            currentLines = mLimitLines;
            a.recycle();
        } else {
            mLinkDrawable = context.getResources().getDrawable(R.drawable.icon_link);
        }
...
//        Pattern pattern = Pattern.compile(regexp, Pattern.CASE_INSENSITIVE);
    ...
    class SelfImageSpan extends ImageSpan {
        ...
        SelfImageSpan(Drawable d, int verticalAlignment) {
